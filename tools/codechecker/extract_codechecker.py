...
class CodecheckerExtractor(SARIFExtractor):
    RULE_IDS = RULE_IDS
    CWE_MESSAGES = CSA_CWE_MESSAGES
    ...
    def _process_result(self, _result_file_path, res, _cwe_type):
        ...
        file_path = self._get_path_from_url(
            first_function_location["physicalLocation"]["artifactLocation"]["uri"]
        )
